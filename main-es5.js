...
var AllRoleStatus = Object.keys(RoleStatus)
    .map(function (key) { return RoleStatus[key]; })
    .filter(function (value) { return !isNaN(Number(value)); });
var RoleFSM = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](RoleFSM, _super);
    // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
    // Life Cycle
    function RoleFSM(name) {
        var _this = _super.call(this) || this;
        // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
        // State
        _this.State = RoleStatus.Idle;
        _this.StateChange = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
        // Extended states
        /** 名稱 */
        _this.Name = '';
        // 職業
        /** 行動值 */
        _this.ActionPoint = 100;
        /** 生命值 */
        _this.HealthPoint = 100;
        /** 魔力值 */
        _this.MagicPoint = 100;
        _this.Name = name;
        return _this;
    ...
    return RoleFSM;
}(src_app_share_basic_fsm_object__WEBPACK_IMPORTED_MODULE_1__["BasicFSMObject"]));
...
var TrafficLightComponent = /** @class */ (function () {
    // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
    ...
    TrafficLightComponent.prototype.ngOnInit = function () {
        // console.log(TraflicLightFSM.AllState);
        var _this = this;
        var timer = Object(rxjs_internal_observable_interval__WEBPACK_IMPORTED_MODULE_3__["interval"])(200)
            ...
            _this.traflicLight.increaseTime();
        });
    };
...
var AllLightStatus = Object.keys(LightStatus)
    .map(function (key) { return LightStatus[key]; })
    .filter(function (value) { return !isNaN(Number(value)); });
var GreenTime = 10;
var YellowTime = 10;
var RedTime = 10;
var TraflicLightFSM = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](TraflicLightFSM, _super);
    // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
    // Life Cycle
    function TraflicLightFSM() {
        var _this = _super.call(this) || this;
        // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
        // State
        ...
        _this.State = LightStatus.Green;
        _this.StateChange = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
        // Extended states
        _this.InGreenTime = 0; // 在 綠燈秒數
        _this.InYellowTime = 0; // 在 黃燈秒數
        _this.InRedTime = 0; // 在 紅燈秒數
        // console.log('EventDictionary', TraflicLightFSM.EventDictionary);
        // console.log('GuardDictionary', TraflicLightFSM.GuardDictionary);
        _this.setupClear();
        return _this;
    }
    TraflicLightFSM.prototype.setupClear = function () {
        var _this = this;
        this.StateChange.subscribe(function (e) {
            switch (e.to) {
                case LightStatus.Green:
                    _this.InGreenTime = 0;
                    break;
                case LightStatus.Yellow:
                    _this.InYellowTime = 0;
                    break;
    ...
    // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
    // Events
    TraflicLightFSM.prototype.increaseTime = function () {
        switch (this.State) {
            case LightStatus.Green:
    ...
    TraflicLightFSM.prototype.increaseGreenTime = function () {
        this.InGreenTime++;
        return true;
    };
    TraflicLightFSM.prototype.increaseYellowTime = function () {
        this.InYellowTime++;
        return true;
    };
    TraflicLightFSM.prototype.increaseRedTime = function () {
        this.InRedTime++;
        return true;
    };
    // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
    // Guard conditions
    TraflicLightFSM.prototype.isInGreenTimeFull = function () {
        return this.InGreenTime >= GreenTime;
    };
    TraflicLightFSM.prototype.isInYellowTimeFull = function () {
        return this.InYellowTime >= YellowTime;
    };
    TraflicLightFSM.prototype.isInRedTimeFull = function () {
    ...
    return TraflicLightFSM;
}(_share_basic_fsm_object__WEBPACK_IMPORTED_MODULE_1__["BasicFSMObject"]));
...
var AllArenaStatus = Object.keys(ArenaStatus)
    .map(function (key) { return ArenaStatus[key]; })
    .filter(function (value) { return !isNaN(Number(value)); });
var ArenaFSM = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ArenaFSM, _super);
    // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
    // Life Cycle
    function ArenaFSM(name) {
        var _this = _super.call(this) || this;
        // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
        // State
        _this.State = ArenaStatus.Idle;
        _this.StateChange = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
        // Extended states
        /** 名稱 */
    ...
    Object.defineProperty(ArenaFSM.prototype, "allRole", {
        get: function () {
    ...
    // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
    // Events
    ArenaFSM.prototype.check = function () {
        var _this = this;
        switch (this.State) {
            case ArenaStatus.Idle:
                for (var _i = 0, _a = this.allRole; _i < _a.length; _i++) {
                    var role = _a[_i];
            ...
            case ArenaStatus.Work:
                var _loop_1 = function (role) {
                    if (role.State === src_app_component_role_role_fsm__WEBPACK_IMPORTED_MODULE_4__["RoleStatus"].Ready) {
                        // 找到對手
                        var UnderAttackRole_1;
                        if (this_1.teamA.includes(role)) {
                            UnderAttackRole_1 = this_1.teamB[0];
                        }
                        else {
                            UnderAttackRole_1 = this_1.teamA[0];
                        }
                        if (!UnderAttackRole_1) {
                            return { value: false };
                        }
                        var cost = random(30, 50);
                        var damage_1 = random(10, 20);
                        role.startWork(cost);
                        this_1.addEventLog(role.Name + " \u6E96\u5099\u653B\u64CA");
                        setTimeout(function () {
                            UnderAttackRole_1.getDamage(damage_1);
                            role.endWork();
                            _this.addEventLog(role.Name + " \u653B\u64CA " + UnderAttackRole_1.Name + " \u9020\u6210 " + damage_1 + " \u50B7\u5BB3");
                        }, 1000);
                    }
                };
                var this_1 = this;
                for (var _b = 0, _c = this.allRole; _b < _c.length; _b++) {
                    var role = _c[_b];
    ...
    // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
    // Guard conditions
    ArenaFSM.prototype.isAnyoneReady = function () {
        for (var _i = 0, _a = this.allRole; _i < _a.length; _i++) {
            var role = _a[_i];
            if (role.State === src_app_component_role_role_fsm__WEBPACK_IMPORTED_MODULE_4__["RoleStatus"].Ready) {
                return true;
    ...
    ArenaFSM.prototype.isAllIdle = function () {
        for (var _i = 0, _a = this.allRole; _i < _a.length; _i++) {
            var role = _a[_i];
    ...
    ArenaFSM.prototype.isAnyoneDie = function () {
        for (var _i = 0, _a = this.allRole; _i < _a.length; _i++) {
            var role = _a[_i];
    ...
    // ====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====.====
    // 其他
    ArenaFSM.prototype.addEventLog = function (msg) {
    ...
    ArenaFSM.ctorParameters = function () { return [
        { type: String }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(src_app_share_basic_fsm_decorator__WEBPACK_IMPORTED_MODULE_2__["State"])(),
...
var ArenaComponent = /** @class */ (function () {
    ...
    ArenaComponent.prototype.ngOnInit = function () {
        var _this = this;
        var timer = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(100)
            // .pipe(take(60))
            .subscribe(function (_) {
            // console.log(this.fsm.State);
            // console.log(this.fsm.ExtendedStates);
...
function State() {
    return function EStateFactory(target, propertyKey) {
        ...
        var getter = function newGetter() {
            if (this.pState === undefined) {
                this.pState = val;
            }
            return this.pState;
        };
        var setter = function newSetter(next) {
            var old = this.pState;
            this.pState = next;
...
function Event(inState) {
    return function EventFactory(target, propertyKey, descriptor) {
        // Write Table
        var dict = target.constructor.EventDictionary;
        // console.log(target.constructor);
        for (var _i = 0, _a = oneToArr(inState); _i < _a.length; _i++) {
            var ele = _a[_i];
            var list = dict.hasOwnProperty(ele) ? dict[ele] : [];
...
function Guard(fromState, toState) {
    return function GuardFactory(target, propertyKey, descriptor) {
        // Write Table
        var dict = target.constructor.GuardDictionary;
        // console.log(target.constructor);
        for (var _i = 0, _a = oneToArr(fromState); _i < _a.length; _i++) {
            var ele = _a[_i];
            var list = dict.hasOwnProperty(ele) ? dict[ele] : [];
            list.push(propertyKey);
            dict[ele] = list;
...
*/
var BasicFSMObject = /** @class */ (function () {
    function BasicFSMObject() {
    ...
    // v 通過後到哪個狀態
    // x log未通過的原因
    BasicFSMObject.prototype.checkAll = function () {
        // tslint:disable-next-line:no-string-literal
        var funcNameList = this.constructor['GuardDictionary'][this.State];
        if (!funcNameList) {
            // 不用 check 的 屬性
            // console.log(this, this.State);
            return;
        }
        for (var _i = 0, funcNameList_1 = funcNameList; _i < funcNameList_1.length; _i++) {
            var funcName = funcNameList_1[_i];
